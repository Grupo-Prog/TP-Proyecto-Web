...
// Form GET 
const $form_cargar_venta_delete = document.getElementById("form_cargar_venta_delete");
...
function validarCampos(){
    ...
    //Cod venta
    if ( $cod_clienteD.value === "Seleccione una venta" | $cod_venta.value === '' | $cod_venta.value === null) {
        document.getElementById('v_input_cod_venta_del').classList.add('inputError');
        return false;
    } else{
        document.getElementById('v_input_cod_venta_del').classList.remove('inputError');
    } 
